...
const AboutUs = () => {
  return (
    ...
    <p className="mb-4 text-xl">
      Welcome to AI Language Course Generator, your ultimate tool for creating personalized AI courses. Our mission is to simplify the learning process by leveraging the power of artificial intelligence to provide tailored educational experiences for users of all levels.
    </p>
    <p className="mb-4 text-xl">
      At AI  Language Course Generator, we believe that everyone should have access to high-quality education. Our platform uses the Gemini API to generate comprehensive course content that meets the needs of students and professionals alike. Whether you are a beginner looking to learn the basics of AI or an experienced practitioner seeking advanced topics, we have something for you.
    </p>
    <p className="mb-4 text-xl">
